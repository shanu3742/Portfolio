...
const PortfolioLayout = ({ children }) => {
    return <div className="page-view bg-gray-950 text-gray-100 font-inter transition-colors duration-300 h-full w-full">


        <header className="sticky top-0 z-50 flex justify-between items-center px-6 lg:px-12 shadow-lg bg-gray-900/90 backdrop-blur-md rounded-b-xl">
        ...
        <footer className="text-center py-6 bg-gray-800 text-gray-300 rounded-t-xl shadow-inner">
            <p className='anotation-view-text-xsm'>&copy; 2025 Kumar Shanu. Built with ❤️ and <a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Tailwind CSS</a>.</p>
        </footer>
    </div>
}
